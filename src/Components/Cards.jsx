  ...
  return (
    <div className=" py-8 px-4 sm:px-6 lg:px-8 flex flex-col justify-center mx-auto max-w-6xl">
      <div className="w-full flex justify-end">
        <Search className="relative left-8 mt-2 size-5 "/>
      <input
  type="text"
  placeholder="Search..."
  className="pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-400"
/>
              </div>
