  ...
  return (
    <div className=''>
        ...
        <div className='flex justify-between xl:max-w-[1320px] md:mr-14  xl:mr-0 my-10 mt-36'>
            ...
            <button className='bg-re-600 text-gray-400 border ms-6 w-24 h-9 rounded-md'>Single NFT</button> 
            <p className='text-[16px] text-gray-400 p-2 ms-5 md:ms-0'>4/4 Generated</p>
    ...
    {/* <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 mx-auto ms-5 '> */}
