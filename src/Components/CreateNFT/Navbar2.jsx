...
//     <>
//       {/* Navbar */}
//       <nav className="fixed top-0 left-0 w-full z-50  bg-white/80 backdrop-blur-md shadow-md flex items-center justify-around py-4 px-6">
//         {/* Logo */}
...
//         >
//           <Link to="/">
//             <li className="text-center hover:underline hover:transition  hover:text-red-500 cursor-pointer uppercase">
//               Home
//             </li>
//           </Link>
//           {/* <Link to="/creatnft1"> */}
//             <li className="hover:text-red-500 cursor-pointer uppercase">
//               AI NFT Generation
//             </li>
//           {/* </Link> */}
//         </ul>
...
//           <button
//             className="w-[76px] h-[38px] md:w-auto bg-gray-400 border border-gray-400 text-black ms-2 font-light px-4 py-0 sm:py-1 rounded hover:bg-red-50"
...
//           <button
//             id="btn-2"
//             className="w[76px] h-[38px] md:w-auto bg-white-200 text-red ms-2 sm:px-4 py-1 border-2 bg-gray-400 border-gray-400 rounded hover:bg-white"
//           >
//             <img src="pera-logo.png" alt=""
    ...
    <>
      ...
      <nav className="fixed top-0 left-0 w-full z-50 bg-white/0 backdrop-blur-md flex items-center justify-between py-4 px-6">
        ...
        <div className="hidden md:flex md:space-x-4 items-center">
          <button
            className="w-full md:w-auto bg-gray-200 border border-gray-2600  px-4 py-1 rounded"
            onClick={() => setIsModalOpen(true)}
          >
            <Wallet size={'20px'}/>
          </button>
          <Link to="/profileseller">
            <button
              className="w-full md:w-auto bg-gray-200 border border-gray-200 text-red-600 px-4 py-1 rounded"
            >
              <img src="./btnimg.png" alt=""  className='w-5 h-5'/>
            </button>
          </Link>
        </div>
      </nav>
          ...
          <div className="flex flex-col items-center">
            ...
            <ul className="space-y-4 text-center">
              <Link to="/" onClick={() => setIsOpen(false)}>
                <li className="text-left font-bold hover:underline text-black hover:transition text-[16px] hover:text-red-500 cursor-pointer uppercase">
                  Home
                </li>
              </Link>
              <Link to="/createnft1" onClick={() => setIsOpen(false)}>
                <li className="hover:text-red-500 hover:underline hover:transition text-black text-[16px] font-bold cursor-pointer uppercase">
                  AI NFT Generation
                </li>
              </Link>
            </ul>
            ...
            <div className="mt-6 w-full">
              <button
                className="  bg-gray-600 border border-gray-600 text-white px-4 py-2 rounded mb-4 ms-8"
                onClick={() => {
                  setIsModalOpen(true);
                  setIsOpen(false);
                }}
